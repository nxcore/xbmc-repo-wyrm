# VideoSource script by Wyrm (xTV-SAF) #
# Reads the sources.xml file for list of media sources and then # 
# prompts user for source to default to when opening in file mode #
